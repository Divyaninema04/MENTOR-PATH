    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="mx-auto max-w-6xl px-6 py-24 md:py-32">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="mt-6 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-sm text-muted-foreground">
              ...
              <span className="inline-flex items-center gap-1.5"><CheckCircle2 className="h-4 w-4 text-primary" /> Instant demo access</span>
              <span className="inline-flex items-center gap-1.5"><CheckCircle2 className="h-4 w-4 text-primary" /> Labour Market Intelligence</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-6xl px-6 pb-24">
        <div className="bento-card gradient-mesh flex flex-col items-start gap-6 md:flex-row md:items-center md:justify-between">
          ...
          <Link to="/dashboard">
            <Button size="lg" className="gap-2">Open your workspace <ArrowRight className="h-4 w-4" /></Button>
          </Link>
        </div>
      </section>
